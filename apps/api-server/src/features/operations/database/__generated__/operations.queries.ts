/** Types generated for queries found in "apps/api-server/src/features/operations/database/operations.sql" */
...
const listProjectsIR: any = {
    usedParamSet: { search: true, status: true, sort: true, limit: true, offset: true },
    params: [
        {
            name: "search",
            required: false,
        ...
        { name: "limit", required: false, transform: { type: "scalar" }, locs: [{ a: 1187, b: 1192 }] },
...
const countProjectsIR: any = {
    usedParamSet: { search: true, status: true },
    params: [
        {
            name: "search",
            required: false,
...
const createProjectIR: any = {
    usedParamSet: { name: true, description: true, status: true, ownerId: true, createdById: true },
    params: [
        { name: "name", required: false, transform: { type: "scalar" }, locs: [{ a: 82, b: 86 }] },
        { name: "description", required: false, transform: { type: "scalar" }, locs: [{ a: 89, b: 100 }] },
        { name: "status", required: false, transform: { type: "scalar" }, locs: [{ a: 103, b: 109 }] },
        { name: "ownerId", required: false, transform: { type: "scalar" }, locs: [{ a: 121, b: 128 }] },
        {
            name: "createdById",
            required: false,
            transform: { type: "scalar" },
...
const updateProjectIR: any = {
    usedParamSet: { name: true, description: true, status: true, ownerId: true, projectId: true },
    params: [
        { name: "name", required: false, transform: { type: "scalar" }, locs: [{ a: 40, b: 44 }] },
        { name: "description", required: false, transform: { type: "scalar" }, locs: [{ a: 81, b: 92 }] },
        { name: "status", required: false, transform: { type: "scalar" }, locs: [{ a: 131, b: 137 }] },
        { name: "ownerId", required: false, transform: { type: "scalar" }, locs: [{ a: 173, b: 180 }] },
...
const listTasksByProjectIdIR: any = {
    usedParamSet: { projectId: true },
 ...
 * ```
 */
export const listTasksByProjectId = new PreparedQuery<IListTasksByProjectIdParams, IListTasksByProjectIdResult>(
    listTasksByProjectIdIR
);
...
const createTaskIR: any = {
    ...
    params: [
        { name: "projectId", required: false, transform: { type: "scalar" }, locs: [{ a: 72, b: 81 }] },
        { name: "title", required: false, transform: { type: "scalar" }, locs: [{ a: 241, b: 246 }] },
        { name: "description", required: false, transform: { type: "scalar" }, locs: [{ a: 249, b: 260 }] },
        { name: "status", required: false, transform: { type: "scalar" }, locs: [{ a: 263, b: 269 }] },
        { name: "priority", required: false, transform: { type: "scalar" }, locs: [{ a: 272, b: 280 }] },
        { name: "assigneeId", required: false, transform: { type: "scalar" }, locs: [{ a: 283, b: 293 }] },
...
const updateTaskIR: any = {
    usedParamSet: {
        ...
        actorRole: true,
        actorId: true,
        adminFieldPatch: true
    },
    params: [
        { name: "taskId", required: false, transform: { type: "scalar" }, locs: [{ a: 79, b: 85 }] },
        { name: "title", required: false, transform: { type: "scalar" }, locs: [{ a: 166, b: 171 }] },
        { name: "description", required: false, transform: { type: "scalar" }, locs: [{ a: 215, b: 226 }] },
        {
            name: "status",
            required: false,
            transform: { type: "scalar" },
        ...
        { name: "priority", required: false, transform: { type: "scalar" }, locs: [{ a: 319, b: 327 }] },
        { name: "replaceAssignee", required: false, transform: { type: "scalar" }, locs: [{ a: 375, b: 390 }] },
        { name: "assigneeId", required: false, transform: { type: "scalar" }, locs: [{ a: 403, b: 413 }] },
        { name: "actorRole", required: false, transform: { type: "scalar" }, locs: [{ a: 547, b: 556 }] },
        { name: "actorId", required: false, transform: { type: "scalar" }, locs: [{ a: 629, b: 636 }] },
...
const listApprovalRequestsIR: any = {
    usedParamSet: { search: true, projectId: true, status: true, sort: true, limit: true, offset: true },
    params: [
        {
            name: "search",
            required: false,
        ...
        { name: "sort", required: false, transform: { type: "scalar" }, locs: [{ a: 912, b: 916 }] },
        { name: "limit", required: false, transform: { type: "scalar" }, locs: [{ a: 997, b: 1002 }] },
 ...
 * ```
 */
export const listApprovalRequests = new PreparedQuery<IListApprovalRequestsParams, IListApprovalRequestsResult>(
    listApprovalRequestsIR
);
...
const countApprovalRequestsIR: any = {
    usedParamSet: { search: true, projectId: true, status: true },
    params: [
        {
            name: "search",
            required: false,
 ...
 * ```
 */
export const countApprovalRequests = new PreparedQuery<ICountApprovalRequestsParams, ICountApprovalRequestsResult>(
    countApprovalRequestsIR
);
...
const getApprovalRequestByIdIR: any = {
 ...
 * ```
 */
export const getApprovalRequestById = new PreparedQuery<IGetApprovalRequestByIdParams, IGetApprovalRequestByIdResult>(
    getApprovalRequestByIdIR
);
...
const createApprovalRequestIR: any = {
    usedParamSet: { projectId: true, title: true, description: true, requesterId: true },
    params: [
        { name: "projectId", required: false, transform: { type: "scalar" }, locs: [{ a: 72, b: 81 }] },
        { name: "title", required: false, transform: { type: "scalar" }, locs: [{ a: 232, b: 237 }] },
        { name: "description", required: false, transform: { type: "scalar" }, locs: [{ a: 240, b: 251 }] },
 ...
 * ```
 */
export const createApprovalRequest = new PreparedQuery<ICreateApprovalRequestParams, ICreateApprovalRequestResult>(
    createApprovalRequestIR
);
...
const reviewApprovalRequestIR: any = {
    usedParamSet: { requestId: true, nextStatus: true, reviewerId: true, reviewComment: true },
    params: [
        { name: "requestId", required: false, transform: { type: "scalar" }, locs: [{ a: 89, b: 98 }] },
        { name: "nextStatus", required: false, transform: { type: "scalar" }, locs: [{ a: 188, b: 198 }] },
        { name: "reviewerId", required: false, transform: { type: "scalar" }, locs: [{ a: 223, b: 233 }] },
 ...
 * ```
 */
export const reviewApprovalRequest = new PreparedQuery<IReviewApprovalRequestParams, IReviewApprovalRequestResult>(
    reviewApprovalRequestIR
);
...
const getDashboardCountsIR: any = {
    usedParamSet: {},
    params: [],
    statement:
 ...
 * ```
 */
export const getDashboardCounts = new PreparedQuery<IGetDashboardCountsParams, IGetDashboardCountsResult>(
    getDashboardCountsIR
);
...
const listDashboardMyTasksIR: any = {
    usedParamSet: { assigneeId: true, limit: true },
    params: [
        { name: "assigneeId", required: false, transform: { type: "scalar" }, locs: [{ a: 564, b: 574 }] },
 ...
 * ```
 */
export const listDashboardMyTasks = new PreparedQuery<IListDashboardMyTasksParams, IListDashboardMyTasksResult>(
    listDashboardMyTasksIR
);
...
const listDashboardPendingRequestsIR: any = {
 ...
 * ```
 */
export const listDashboardPendingRequests = new PreparedQuery<
    IListDashboardPendingRequestsParams,
    IListDashboardPendingRequestsResult
>(listDashboardPendingRequestsIR);
...
const listDashboardRecentPostsIR: any = {
    usedParamSet: { limit: true },
    params: [{ name: "limit", required: false, transform: { type: "scalar" }, locs: [{ a: 414, b: 419 }] }],
    statement:
 ...
 * ```
 */
export const listDashboardRecentPosts = new PreparedQuery<
    IListDashboardRecentPostsParams,
    IListDashboardRecentPostsResult
>(listDashboardRecentPostsIR);
