/** Types generated for queries found in "src/features/auth/database/auth.sql" */
...
const findUserByLoginIdOrEmailIR: any = {"usedParamSet":{"loginId":true,"email":true},"params":[{"name":"loginId","required":false,"transform":{"type":"scalar"},"locs":[{"a":39,"b":46}]},{"name":"email","required":false,"transform":{"type":"scalar"},"locs":[{"a":62,"b":67}]}],"statement":"SELECT id\nFROM \"user\"\nWHERE login_id = :loginId\n   OR email = :email\nLIMIT 1                                                                 "};
 ...
 * ```
 */
export const findUserByLoginIdOrEmail = new PreparedQuery<IFindUserByLoginIdOrEmailParams,IFindUserByLoginIdOrEmailResult>(findUserByLoginIdOrEmailIR);
