/** Types generated for queries found in "src/features/board/database/board.sql" */
...
const incrementPostViewIR: any = {"usedParamSet":{"postId":true},"params":[{"name":"postId","required":false,"transform":{"type":"scalar"},"locs":[{"a":56,"b":62}]}],"statement":"UPDATE posts\nSET view_count = view_count + 1\nWHERE id = :postId::int4\nRETURNING id                                                                         "};
 ...
 * ```
 */
export const incrementPostView = new PreparedQuery<IIncrementPostViewParams,IIncrementPostViewResult>(incrementPostViewIR);
...
const getPostByIdIR: any = {"usedParamSet":{"postId":true},"params":[{"name":"postId","required":false,"transform":{"type":"scalar"},"locs":[{"a":394,"b":400}]}],"statement":"SELECT\n    p.id,\n    p.title,\n    p.content,\n    p.author_id AS \"authorId\",\n    u.display_name AS \"authorName\",\n    p.view_count AS \"viewCount\",\n    p.created_at AS \"createdAt\",\n    p.updated_at AS \"updatedAt\",\n    (\n        SELECT count(*)::int4\n        FROM comments c\n        WHERE c.post_id = p.id\n    ) AS \"commentCount\"\nFROM posts p\nINNER JOIN \"user\" u ON u.id = p.author_id\nWHERE p.id = :postId::int4                                                               "};
...
const listCommentsByPostIdIR: any = {"usedParamSet":{"postId":true},"params":[{"name":"postId","required":false,"transform":{"type":"scalar"},"locs":[{"a":267,"b":273}]}],"statement":"SELECT\n    c.id,\n    c.post_id AS \"postId\",\n    c.author_id AS \"authorId\",\n    u.display_name AS \"authorName\",\n    c.content,\n    c.created_at AS \"createdAt\",\n    c.updated_at AS \"updatedAt\"\nFROM comments c\nINNER JOIN \"user\" u ON u.id = c.author_id\nWHERE c.post_id = :postId::int4\nORDER BY c.created_at ASC                                                         "};
 ...
 * ```
 */
export const listCommentsByPostId = new PreparedQuery<IListCommentsByPostIdParams,IListCommentsByPostIdResult>(listCommentsByPostIdIR);
...
const createPostIR: any = {"usedParamSet":{"title":true,"content":true,"authorId":true},"params":[{"name":"title","required":false,"transform":{"type":"scalar"},"locs":[{"a":85,"b":90}]},{"name":"content","required":false,"transform":{"type":"scalar"},"locs":[{"a":93,"b":100}]},{"name":"authorId","required":false,"transform":{"type":"scalar"},"locs":[{"a":103,"b":111}]}],"statement":"WITH created_post AS (\n    INSERT INTO posts (title, content, author_id)\n    VALUES (:title, :content, :authorId::int4)\n    RETURNING id\n)\nSELECT id\nFROM created_post                                                                      "};
...
const updatePostIR: any = {"usedParamSet":{"postId":true,"title":true,"content":true,"actorId":true,"actorRole":true},"params":[{"name":"postId","required":false,"transform":{"type":"scalar"},"locs":[{"a":77,"b":83}]},{"name":"title","required":false,"transform":{"type":"scalar"},"locs":[{"a":164,"b":169}]},{"name":"content","required":false,"transform":{"type":"scalar"},"locs":[{"a":209,"b":216}]},{"name":"actorId","required":false,"transform":{"type":"scalar"},"locs":[{"a":346,"b":353}]},{"name":"actorRole","required":false,"transform":{"type":"scalar"},"locs":[{"a":364,"b":373}]}],"statement":"WITH target_post AS (\n    SELECT id, author_id\n    FROM posts\n    WHERE id = :postId::int4\n),\nupdated_post AS (\n    UPDATE posts p\n    SET\n        title = COALESCE(:title, p.title),\n        content = COALESCE(:content, p.content),\n        updated_at = now()\n    FROM target_post\n    WHERE p.id = target_post.id\n      AND (target_post.author_id = :actorId::int4 OR :actorRole::text = 'ADMIN')\n    RETURNING p.id\n)\nSELECT\n    target_post.id,\n    target_post.author_id AS \"authorId\",\n    updated_post.id AS \"updatedId\"\nFROM target_post\nLEFT JOIN updated_post ON true                                                                      "};
...
const deletePostIR: any = {"usedParamSet":{"postId":true,"actorId":true,"actorRole":true},"params":[{"name":"postId","required":false,"transform":{"type":"scalar"},"locs":[{"a":77,"b":83}]},{"name":"actorId","required":false,"transform":{"type":"scalar"},"locs":[{"a":225,"b":232}]},{"name":"actorRole","required":false,"transform":{"type":"scalar"},"locs":[{"a":243,"b":252}]}],"statement":"WITH target_post AS (\n    SELECT id, author_id\n    FROM posts\n    WHERE id = :postId::int4\n),\ndeleted_post AS (\n    DELETE FROM posts p\n    USING target_post\n    WHERE p.id = target_post.id\n      AND (target_post.author_id = :actorId::int4 OR :actorRole::text = 'ADMIN')\n    RETURNING p.id\n)\nSELECT\n    target_post.id,\n    target_post.author_id AS \"authorId\",\n    deleted_post.id AS \"deletedId\"\nFROM target_post\nLEFT JOIN deleted_post ON true                                                                 "};
...
const createCommentIR: any = {"usedParamSet":{"postId":true,"authorId":true,"content":true},"params":[{"name":"postId","required":false,"transform":{"type":"scalar"},"locs":[{"a":66,"b":72}]},{"name":"authorId","required":false,"transform":{"type":"scalar"},"locs":[{"a":186,"b":194}]},{"name":"content","required":false,"transform":{"type":"scalar"},"locs":[{"a":203,"b":210}]}],"statement":"WITH target_post AS (\n    SELECT id\n    FROM posts\n    WHERE id = :postId::int4\n),\ncreated_comment AS (\n    INSERT INTO comments (post_id, author_id, content)\n    SELECT target_post.id, :authorId::int4, :content\n    FROM target_post\n    RETURNING id\n)\nSELECT\n    target_post.id AS \"postId\",\n    created_comment.id AS \"commentId\"\nFROM target_post\nLEFT JOIN created_comment ON true                                                                         "};
...
const updateCommentIR: any = {"usedParamSet":{"commentId":true,"content":true,"actorId":true,"actorRole":true},"params":[{"name":"commentId","required":false,"transform":{"type":"scalar"},"locs":[{"a":83,"b":92}]},{"name":"content","required":false,"transform":{"type":"scalar"},"locs":[{"a":172,"b":179}]},{"name":"actorId","required":false,"transform":{"type":"scalar"},"locs":[{"a":306,"b":313}]},{"name":"actorRole","required":false,"transform":{"type":"scalar"},"locs":[{"a":324,"b":333}]}],"statement":"WITH target_comment AS (\n    SELECT id, author_id\n    FROM comments\n    WHERE id = :commentId::int4\n),\nupdated_comment AS (\n    UPDATE comments c\n    SET\n        content = :content,\n        updated_at = now()\n    FROM target_comment\n    WHERE c.id = target_comment.id\n      AND (target_comment.author_id = :actorId::int4 OR :actorRole::text = 'ADMIN')\n    RETURNING c.id\n)\nSELECT\n    target_comment.id,\n    target_comment.author_id AS \"authorId\",\n    updated_comment.id AS \"updatedId\"\nFROM target_comment\nLEFT JOIN updated_comment ON true                                                                         "};
...
const deleteCommentIR: any = {"usedParamSet":{"commentId":true,"actorId":true,"actorRole":true},"params":[{"name":"commentId","required":false,"transform":{"type":"scalar"},"locs":[{"a":83,"b":92}]},{"name":"actorId","required":false,"transform":{"type":"scalar"},"locs":[{"a":249,"b":256}]},{"name":"actorRole","required":false,"transform":{"type":"scalar"},"locs":[{"a":267,"b":276}]}],"statement":"WITH target_comment AS (\n    SELECT id, author_id\n    FROM comments\n    WHERE id = :commentId::int4\n),\ndeleted_comment AS (\n    DELETE FROM comments c\n    USING target_comment\n    WHERE c.id = target_comment.id\n      AND (target_comment.author_id = :actorId::int4 OR :actorRole::text = 'ADMIN')\n    RETURNING c.id\n)\nSELECT\n    target_comment.id,\n    target_comment.author_id AS \"authorId\",\n    deleted_comment.id AS \"deletedId\"\nFROM target_comment\nLEFT JOIN deleted_comment ON true"};
